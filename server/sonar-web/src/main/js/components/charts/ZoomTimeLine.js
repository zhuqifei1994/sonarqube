...
export default class ZoomTimeLine extends React.PureComponent {
  ...
  constructor(props: Props) {
    ...
    this.handleSelectionDrag = throttle(this.handleSelectionDrag, 40);
    this.handleNewZoomDrag = throttle(this.handleNewZoomDrag, 40);
    this.handleSelectionHandleDrag = throttle(this.handleSelectionHandleDrag, 40);
  }
