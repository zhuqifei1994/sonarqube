...
public class CeConfigurationImplTest {
  ...
  public void getWorkerThreadCount_returns_1_when_there_is_no_WorkerCountProvider() {
    assertThat(new CeConfigurationImpl().getWorkerThreadCount()).isEqualTo(1);
  }
  ...
  public void getWorkerThreadCount_returns_10_whichever_the_value_returned_by_WorkerCountProvider() {
    ...
    assertThat(new CeConfigurationImpl(workerCountProvider).getWorkerThreadCount()).isEqualTo(10);
  }
  ...
  public void refresh_does_not_change_any_value_when_there_is_no_WorkerCountProvider() {
    ...
    int workerThreadCount = underTest.getWorkerThreadCount();
    ...
    IntStream.range(0, 1 + abs(new Random().nextInt(10)))
      .forEach(ignored -> {
        ...
        assertThat(underTest.getWorkerThreadCount()).isEqualTo(workerThreadCount);
