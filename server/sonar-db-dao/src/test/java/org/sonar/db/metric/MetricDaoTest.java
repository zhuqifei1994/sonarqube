...
public class MetricDaoTest {
  ...
  @Test
  public void fail_insert_if_key_is_longer_than_64_characters() {
    ...
    underTest.insert(dbSession, newMetricDto().setKey(a65));
  }

  @Test
  public void fail_update_if_name_is_longer_than_64_characters() {
    MetricDto metric = underTest.insert(dbSession, newMetricDto());
    ...
    underTest.update(dbSession, metric);
  }
}
